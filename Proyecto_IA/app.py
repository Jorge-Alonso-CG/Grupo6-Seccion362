            ...
            with st.chat_message("assistant"):
                with st.spinner("Sweetie está pensando..."):
                    ...
                    try:
                        ...
                        system_instruction = f"""Eres "Sweetie", asistenta virtual de Sweet & Healthy, una tienda de postres saludables. Responde siempre en español, de forma amable y concisa. Solo debes responder preguntas relacionadas con: el catálogo de productos, precios, ingredientes, beneficios nutricionales, calorías, stock disponible, métodos de pago (Yape, Plin, efectivo), tiempos de entrega (2-3 horas dentro de la ciudad), disponibilidad, y políticas de devolución (no aplica para productos perecederos). Si te preguntan algo fuera de estos temas, redirige amablemente la conversación hacia los productos.
                        ...
                        response_text = f"¡Hola! Lo siento, experimenté una dificultad al procesar tu solicitud: {str(e)}. Por favor, inténtalo de nuevo en unos momentos."
